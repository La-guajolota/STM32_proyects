...
#define signal_A_Pin GPIO_PIN_7
#define signal_A_GPIO_Port GPIOG
#define signal_A_EXTI_IRQn EXTI9_5_IRQn
#define signal_B_Pin GPIO_PIN_6
#define signal_B_GPIO_Port GPIOG
